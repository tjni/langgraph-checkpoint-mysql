...
async def test_start_branch_then(async_checkpointer: BaseCheckpointSaver) -> None:
...
async def test_doubly_nested_graph_state(async_checkpointer: BaseCheckpointSaver) -> None:
    class State(TypedDict):
        my_key: str
